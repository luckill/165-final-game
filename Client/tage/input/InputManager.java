...
//		return controllerActions.get(c).put(component, action);
     ...
     * specified component on the specified controller changes state).
     *
     * @param controller - the controller with which the action is to be associated
     * @param component  - identifier of the component with which the action is to be
     *                   associated
     * @param action     - the action which is to be associated with the specified
     *                   component
     * @param actionType -- indicates when the action is to be invoked in relation to
     *                   the occurrence of component events
     * @return the action which was previously associated with the specified
     * component, or null if there was no previously associated action.
     */
    ...
    /**
     * Specialized version of associateAction, that associate an action on all mouse
     * @param key - specific key or button for triggering the action class
     * @param action - the specific action class
     * @param actionType - the type fo action
     */
    public void associateActionWithAllMouse(Component.Identifier key, IAction action, INPUT_ACTION_TYPE actionType)
    {
        ArrayList<Controller> controllers = getControllers();
        for (Controller controller : controllers)
        {
            ...
            {
                associateAction(controller, key, action, actionType);
            }
        }
    }
}
