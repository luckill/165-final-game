...
public class GameObject
{
	...
	*/
	...
	//--------- MATRICES ROTATION and vector manipulation----------

	/**
	 * rotate the object along its global up axis
	 */
	...
	/**
	 * move the object froward/backward along its local forward axis
	 */
	public void moveForwardOrBackward(double scalar)
	{
		this.setLocalLocation(this.getWorldLocation().add(this.getLocalForwardVector().mul((float) scalar)));
	}
